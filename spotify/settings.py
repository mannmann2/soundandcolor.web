...
SECRET_KEY = 'twaks-&fh^c%3z#qm7*pjfj-hln_=53^x#e$def8n$bswu8xy1'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries':{
                'index': 'stats.templates.templatetags.index',
...
DATABASES = {
    'default': {
        ...
        'NAME': '/Users/tom/Desktop/db.sqlite3',
...
STATIC_URL = '/static/'
MEDIA_URL = '/media/'
MEDIA_ROOT = '/Users/tom/Desktop/media'